            ...
            <form action="" id="formasistencia">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input type="datetime-local" id="fecha_hora_salida" name="fecha_hora_salida" value="<?php echo date("Y-m-d") .'T12:30' ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
