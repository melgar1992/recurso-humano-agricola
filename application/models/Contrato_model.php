...
class Contrato_model extends CI_Model
{
    ...
    public function obtenerContratosVigentes()
    {
        ...
        $this->db->join('cargo ca', 'ca.id_cargo = co.id_cargo');
        $this->db->where('co.estado', '1');
        $this->db->where('co.fecha_fin >', date("Y-m-d"));
        $this->db->where('ca.estado', '1');
        $this->db->where('em.estado', '1');
        return $this->db->get()->result_array();
    }
    ...
    public function ingresarContrato($id_empleado, $id_cargo, $fecha_inicio, $fecha_fin)
    {
        $datos = array(
    ...
    public function editarContrato($id_contrato, $id_empleado, $id_cargo, $fecha_inicio, $fecha_fin)
    {
        $datos = array(
            'id_empleado' => $id_empleado,
            'id_cargo' => $id_cargo,
